    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Documentation for the usage of our app and api" />
            ...
            <main className="flex min-h-screen flex-col items-center justify-center bg-slate-900 text-slate-100">
                ...
                <p className="text-5xl">Documentation for the usage of our app and api</p>
                        ...
                        <div>
                            ...
                            <div className="px-2">
                                ...
                                <div className="px-2">
                                    ...
                                    <p>
                                        This will download the file from the github repo. The file will be zipped.
                                    </p>
                                </div>
                                <h3>upload</h3>
                                <div className="px-2">
